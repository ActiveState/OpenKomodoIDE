...
this.getPrintdebugTool = (language) =>
{
    return this.manager.toolsMgr.getPrintdebugTool(language);
};

this.getgetPrintdebugToolByPath = (language, path) =>
{
    return this.manager.toolsMgr.getAbbreviationSnippet(language, path);
};
...
this.getDefaultPrintStateForLanguage = function(language) {
    return this.manager.toolsMgr.getDefaultPrintStateForLanguage(language);
};
