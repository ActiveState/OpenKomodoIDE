...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-docker/", "chrome://scope-shell-docker/content/sdk/");
        window.require("scope-shell-docker/docker").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Docker'");
        Cu.reportError(e);
    }
}
