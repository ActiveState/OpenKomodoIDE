...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-drush/", "chrome://scope-shell-drush/content/sdk/");
        window.require("scope-shell-drush/drush").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Drush'");
        Cu.reportError(e);
    }
}
