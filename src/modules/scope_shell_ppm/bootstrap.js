...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-ppm/", "chrome://scope-shell-ppm/content/sdk/");
        window.require("scope-shell-ppm/ppm").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - PPM'");
        Cu.reportError(e);
    }
}
