...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-cordova/", "chrome://scope-shell-cordova/content/sdk/");
        window.require("scope-shell-cordova/cordova").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Cordova'");
        Cu.reportError(e);
    }
}
