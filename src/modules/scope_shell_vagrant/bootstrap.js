...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-vagrant/", "chrome://scope-shell-vagrant/content/sdk/");
        window.require("scope-shell-vagrant/vagrant").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Vagrant'");
        Cu.reportError(e);
    }
}
