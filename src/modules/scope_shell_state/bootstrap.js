...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-state/", "chrome://scope-shell-state/content/sdk/");
        window.require("scope-shell-state/state").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - State'");
        Cu.reportError(e);
    }
}
