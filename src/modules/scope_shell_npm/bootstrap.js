...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-npm/", "chrome://scope-shell-npm/content/sdk/");
        window.require("scope-shell-npm/npm").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - NPM'");
        Cu.reportError(e);
    }
}
