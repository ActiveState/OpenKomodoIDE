...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-composer/", "chrome://scope-shell-composer/content/sdk/");
        window.require("scope-shell-composer/composer").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Composer'");
        Cu.reportError(e);
    }
}
