...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-phonegap/", "chrome://scope-shell-phonegap/content/sdk/");
        window.require("scope-shell-phonegap/phonegap").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - PhoneGap'");
        Cu.reportError(e);
    }
}
