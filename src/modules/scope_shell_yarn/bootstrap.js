...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-yarn/", "chrome://scope-shell-yarn/content/sdk/");
        window.require("scope-shell-yarn/yarn").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Yarn'");
        Cu.reportError(e);
    }
}
