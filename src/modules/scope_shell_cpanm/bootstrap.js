...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-cpanm/", "chrome://scope-shell-cpanm/content/sdk/");
        window.require("scope-shell-cpanm/cpanm").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - cpanm'");
        Cu.reportError(e);
    }
}
