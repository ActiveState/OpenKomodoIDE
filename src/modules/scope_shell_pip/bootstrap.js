...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-pip/", "chrome://scope-shell-pip/content/sdk/");
        window.require("scope-shell-pip/pip").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Pip'");
        Cu.reportError(e);
    }
}
