...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-bower/", "chrome://scope-shell-bower/content/sdk/");
        window.require("scope-shell-bower/bower").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Bower'");
        Cu.reportError(e);
    }
}
