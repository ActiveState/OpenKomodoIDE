...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-grunt/", "chrome://scope-shell-grunt/content/sdk/");
        window.require("scope-shell-grunt/grunt").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Grunt'");
        Cu.reportError(e);
    }
}
