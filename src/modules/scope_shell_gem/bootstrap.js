...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("scope-shell-gem/", "chrome://scope-shell-gem/content/sdk/");
        window.require("scope-shell-gem/gem").register();
    } catch (e) {
        Cu.reportError("Commando: Exception while registering scope 'Shell - Gem'");
        Cu.reportError(e);
    }
}
