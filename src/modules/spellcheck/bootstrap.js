...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("spellcheck/", "chrome://komodospellchecker/content/");
        window.require("spellcheck/spellcheck").load();
    } catch (e) {
...
function unloadFromWindow(window) {
    if (!window) return;
    window.require("spellcheck/spellcheck").unload();
}
