...
NPP_New(NPMIMEType /*pluginType*/, NPP instance, uint16_t /*mode*/, int16_t /*argc*/, char** /*argn[]*/, char** /*argv[]*/, NPSavedData* /*saved*/) {
  ...
  #ifdef SCIMOZ_DEBUG
    fprintf(stderr, "NPP_New:: NPPVpluginDrawingModel set to NPDrawingModelInvalidatingCoreAnimation\n");
  #endif   
#else
  // Check if the browser supports the CoreAnimation drawing model
  ...
  #ifdef SCIMOZ_DEBUG
    fprintf(stderr, "NPP_New:: NPPVpluginDrawingModel set to NPDrawingModelCoreAnimation\n");
  #endif   
#endif
#else
  ...
  #ifdef SCIMOZ_DEBUG
    fprintf(stderr, "NPP_New:: NPPVpluginDrawingModel set to NPDrawingModelCoreGraphics\n");
  #endif   
  ...
  #ifdef SCIMOZ_DEBUG
    fprintf(stderr, "NPP_New:: NPPVpluginEventModel set to NPEventModelCocoa\n");
  #endif   
#endif /* USE_COCOA */
...
NPP_GetValue(NPP instance, NPPVariable variable, void *value) {
  switch (variable) {
    case NPPVpluginNameString:
      #ifdef SCIMOZ_DEBUG
        fprintf(stderr, "NPP_GetValue:: PLUGIN_NAME\n");
      #endif
    ...
    case NPPVpluginDescriptionString:
      #ifdef SCIMOZ_DEBUG
        fprintf(stderr, "NPP_GetValue:: PLUGIN_DESCRIPTION\n");
      #endif   
    ...
    case NPPVpluginNeedsXEmbed:
      #ifdef SCIMOZ_DEBUG
        fprintf(stderr, "NPP_GetValue:: NPPVpluginNeedsXEmbed\n");
      #endif   
      *((bool *)value) = PR_TRUE;
      return NPERR_NO_ERROR;
#endif
    ...
    {
      #ifdef SCIMOZ_DEBUG
        fprintf(stderr, "NPP_GetValue:: NPPVpluginCoreAnimationLayer\n");
      #endif   
      SciMozPluginInstance* scimozPlugin = (SciMozPluginInstance*)(instance->pdata);
    ...
    default:
      #ifdef SCIMOZ_DEBUG
        fprintf(stderr, "NPP_GetValue:: Unhandled variable %d\n", variable);
      #endif
